...
- (void)loadView {
  ...
  UIBarButtonItem *exportButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemReply
                                                                                target:self
...
- (void)trashPhoto {
  ...
  UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self
                                                  cancelButtonTitle:NSLocalizedString(@"取消", @"Cancel button text.") destructiveButtonTitle:NSLocalizedString(@"删除图片", @"Delete Photo button text.") otherButtonTitles:nil];
